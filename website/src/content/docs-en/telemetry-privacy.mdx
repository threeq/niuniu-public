...
- To delete raw events tied to that `install_id`, submit a deletion request with the `install_id` via the [official website](https://www.niu6ai.com) or a [public-repo issue](https://github.com/threeq/niuniu/issues).
