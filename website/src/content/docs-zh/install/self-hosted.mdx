...
```bash
git clone https://github.com/threeq/niuniu.git
...
[GitHub Releases](https://github.com/threeq/niuniu/releases) 提供 macOS / Windows / Linux 桌面安装包（内置 niuniu-server，适合单机使用）；服务器裸二进制不随 Release 发布，Linux 服务器请使用上面的源码构建方式。
...
Documentation=https://github.com/threeq/niuniu
